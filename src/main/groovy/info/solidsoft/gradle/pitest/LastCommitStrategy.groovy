...
class LastCommitChangesScmStatistics extends AbstractScmChangeLogStatistics {
    LastCommitChangesScmStatistics(File scmRoot, ScmManager scmManager, Set<ScmFileStatus> includingFileStatuses, String repository) {
